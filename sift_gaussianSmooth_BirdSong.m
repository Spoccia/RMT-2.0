...
%                 descriptors = [descriptors, sh] ;
                ...
                sh_silv=siftdescriptor_Silv(...
                        fgss_silv{oframeSilv(3,1)-gss.sminD+1,oframeSilv(4,1)-gss.sminT+1,oframes(1,f)+1},...fgss_silv{oframeSilv(3,1)-gss.sminD+1,oframeSilv(4,1)-gss.sminT+1,oframes(1,f)},...% gss.octave{otime, odepd}(:,:,oframes(3,1)-gss.sminD+1,oframes(4,1)-gss.sminT+1),...%THIS IS THE SCALE OF THE FEATURE F (TIME,VARIATE,SD,ST)
