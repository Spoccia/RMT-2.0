 ...
 *
 * _coder_Unpaired_pruning_DAFS_DAFS_DV_api.c
 *
 * Code generation for function '_coder_Unpaired_pruning_DAFS_DAFS_DV_api'
 *
 */
...
#include "_coder_Unpaired_pruning_DAFS_DAFS_DV_api.h"
...
static emlrtRTEInfo j_emlrtRTEI = { 1, 1,
  "_coder_Unpaired_pruning_DAFS_DAFS_DV_api", "" };
...
void Unpaired_pruning_DAFS_DAFS_DV_api(const mxArray * const prhs[8], const
  mxArray *plhs[2])
{
  ...
  emxInit_real_T(&st, &feature1, 2, &j_emlrtRTEI, true);
  emxInit_real_T(&st, &depdScale1, 2, &j_emlrtRTEI, true);
  emxInit_real_T(&st, &matches, 2, &j_emlrtRTEI, true);
  emxInit_real_T(&st, &combineScore, 2, &j_emlrtRTEI, true);
  emxInit_real_T(&st, &feature2, 2, &j_emlrtRTEI, true);
  emxInit_real_T(&st, &depdScale2, 2, &j_emlrtRTEI, true);
  emxInit_real_T(&st, &remainQOctave, 2, &j_emlrtRTEI, true);
  ...
  Unpaired_pruning_DAFS_DAFS_DV(&st, feature1, depdScale1, matches, combineScore,
    feature2, depdScale2, doctave, toctave, remainQOctave, &Dist);
...
/* End of code generation (_coder_Unpaired_pruning_DAFS_DAFS_DV_api.c) */
