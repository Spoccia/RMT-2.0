...
#include "Unpaired_pruning_DAFS_DAFS_DV_mexutil.h"
...
static emlrtRTEInfo h_emlrtRTEI = { 1, 20, "sort",
  "C:\\Program Files\\MATLAB\\R2015b\\toolbox\\eml\\eml\\+coder\\+internal\\sort.m"
};

static emlrtRTEInfo k_emlrtRTEI = { 406, 9, "sortIdx",
  "C:\\Program Files\\MATLAB\\R2015b\\toolbox\\eml\\eml\\+coder\\+internal\\sortIdx.m"
};

static emlrtRTEInfo l_emlrtRTEI = { 408, 9, "sortIdx",
  "C:\\Program Files\\MATLAB\\R2015b\\toolbox\\eml\\eml\\+coder\\+internal\\sortIdx.m"
};

static emlrtRTEInfo m_emlrtRTEI = { 331, 14, "sortIdx",
  "C:\\Program Files\\MATLAB\\R2015b\\toolbox\\eml\\eml\\+coder\\+internal\\sortIdx.m"
};

static emlrtRTEInfo n_emlrtRTEI = { 331, 20, "sortIdx",
  "C:\\Program Files\\MATLAB\\R2015b\\toolbox\\eml\\eml\\+coder\\+internal\\sortIdx.m"
};
...
void sort(const emlrtStack *sp, emxArray_real_T *x, emxArray_int32_T *idx)
{
  ...
  emxInit_int32_T1(&c_st, &iwork, 1, &m_emlrtRTEI, true);
  m = x->size[1];
  ib = iwork->size[0];
  iwork->size[0] = m;
  ...
  emxInit_real_T1(&c_st, &xwork, 1, &n_emlrtRTEI, true);
  m = x->size[1];
  ib = xwork->size[0];
  xwork->size[0] = m;
