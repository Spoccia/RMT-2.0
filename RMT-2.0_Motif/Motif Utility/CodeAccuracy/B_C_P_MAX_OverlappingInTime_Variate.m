...
csvwrite([path,kindofinj,'Accuracy\FeatureFoundAnalisys\BP_',TEST,'_FeaturesFounded_DepO',DepO,'_DepT_',DepT,'.csv'],Featurepruned);
csvwrite([path,kindofinj,'Accuracy\FeatureFoundAnalisys\BP_',TEST,'_DependencyFounded_DepO',DepO,'_DepT_',DepT,'.csv'],Dependencypruned);