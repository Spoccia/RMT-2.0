function [ output_args ] = ShowKmeansCluster(TEST,imagepath,specificimagepath,imagename,K_valuesCalc,distanceUsed,typeofCluster,histdataimage )
...
ImageSavingPath=[saveFeaturesPath,'DistancesDescriptors\Cluster_Fixed\Descriptor\BeforePruningMatlabKmeans_CosineDescriptor\imageMotifs\',imagename];
RebSeriesPath = [saveFeaturesPath,'DistancesDescriptors\Cluster_',K_valuesCalc,'\',distanceUsed,'\BeforePruningMatlabKmeans_CosineDescriptor\rebClusters\'];
