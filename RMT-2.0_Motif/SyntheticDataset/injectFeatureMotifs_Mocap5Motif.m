...
csvwrite([DestDataPath,'\IndexEmbeddedFeatures\',num2str(name+6),'\','FeaturePosition_Mocap_test',num2str(name+6),'.csv'],FeatPositions);
csvwrite([DestDataPath,'\IndexEmbeddedFeatures\',num2str(name+6),'\','dpscale_Mocap_test',num2str(name+6),'.csv'],EachInstanceDependency);
csvwrite([DestDataPath,'\IndexEmbeddedFeatures\',num2str(name+6),'\','FeaturesEmbedded_Mocap_test',num2str(name+6),'.csv'],A);
end