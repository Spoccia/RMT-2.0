...
num_of_motif = 3;
num_of_motif_injected = 10;
% GroundTruthFilePath = ['/Users/sliu104/Desktop/Test_Case_Jan_30/Variate_Shifted_GroundTruth/FeaturePosition_MotifShift'];
GroundTruthFilePath = ['/Users/sliu104/Desktop/Test_Case_Jan_30/GroundTruth_All/FeaturePosition_Motif'];
...
% RMEMotifFilePath = ['/Users/sliu104/Desktop/Test_Case_Jan_30/RME_Accuracy_Motif1_2/AP_DepO_2_DepT_2_Motif'];
RMEMotifFilePath = ['/Users/sliu104/Desktop/Test_Case_Jan_30/RME_Accuracy_Motif3/AP_DepO_2_DepT_2_Motif'];
...
% savePathRME = ['/Users/sliu104/Desktop/Test_Case_Jan_30_Results/RME_Accuray_Motif1/'];
savePathRME = ['/Users/sliu104/Desktop/Test_Case_Jan_30_Results/RME_Accuray_Motif3'];
...
for j = 1 : size(TS_index, 2)
    for i = 1 : size(testCaseIndex, 2)
        ...
        RMEMotifFile = [RMEMotifFilePath, num2str(num_of_motif), '_', num2str(TS_index(j)), '_instance_', num2str(testCaseIndex(i)), '.csv'];
        ...
        savePathRMEPrecision = [savePathRME, '/RMEPrecision_', num2str(index_count), '.csv'];
        savePathRMERecall = [savePathRME, '/RMERecall_', num2str(index_count), '.csv'];
        savePathRMEFScore = [savePathRME, '/RMEFScore_', num2str(index_count), '.csv'];
        savePathRemainIndex = [savePathRME, '/RemainIndex', num2str(index_count), '.csv'];
