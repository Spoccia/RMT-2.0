        ...
        for j = 1 : size(strategy, 2)
            for aa = 1 : size(amp_scale, 2)
                for kk = 1 : size(algorithm_type, 2)
                    ...
                    sharedFolder = ['/Users/sliu104/Desktop/MyMotif/Silvestro_Aug_20/Result_', cur_algorithm_type, '_Motif', num2str(cur_num_of_motif), '/Strategy_', num2str(cur_strategy), '/amp_scale_', num2str(amp_scale(aa)), '_TO_', num2str(timeOverlapThreshold)];
