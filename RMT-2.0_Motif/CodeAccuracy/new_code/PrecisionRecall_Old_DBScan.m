        ...
        for i = 1 : size(num_of_motif, 2)
            ...
            for j = 1 : size(TS_index, 2)
                for k = 1 : size(testCaseIndex, 2)
                    ...
                    RMTMotifFilePath = ['/Users/sliu104/Desktop/Results_Motif/Synthetic_Dataset/Features_RMT/Accuracy_Motif', num2str(num_of_motif(i)),'/Strategy_'];
                    ...
                    RMTMotifFile = [RMTMotifFilePath, num2str(strategy(ss)), '/AP_DepO_2_DepT_2_Motif', num2str(num_of_motif(i)), '_', num2str(TS_index(j)), '_instance_', num2str(testCaseIndex(k)), '.csv'];
                    ...
                    sharedFolder = [savePathRMT, num2str(num_of_motif(i)), '/Strategy_', num2str(strategy(ss)), '/TO_', num2str(timeOverlapThreshold)];
                    ...
                    savePathRMTPrecision = [sharedFolder, '/RMTPrecision_', num2str(index_count), '.csv'];
                    savePathRMTRecall = [sharedFolder, '/RMTRecall_', num2str(index_count), '.csv'];
                    savePathRMTFScore = [sharedFolder, '/RMTFScore_', num2str(index_count), '.csv'];
                ...
                RMT_Entropy_Ouput_Path = [savePathRMT, num2str(num_of_motif(i)), '/Strategy_', num2str(strategy(ss)), '/TO_', num2str(timeOverlapThreshold), '/RMTMotifEntropy.csv'];
