...
for i = 1 : size(num_of_motif, 2)
    for j = 1 : size(strategy, 2)
        for k = 1 : size(amp_scale, 2)
            ...
            fprintf('num_of_motif: %d, strategy: %d, algorithm_type: %s, amp_scale: %f . \n', cur_num_of_motif, cur_strategy, cur_algorithm_type, amp_scale(k));
            
            precision_file_path = ['/Users/sliu104/Desktop/Results_Motif_Save/Motif', num2str(cur_num_of_motif), '/Strategy_', num2str(cur_strategy), '/amp_scale_', num2str(amp_scale(k)), '/', algorithm_type, 'Precision_'];
            recall_file_path = ['/Users/sliu104/Desktop/Results_Motif_Save/Motif', num2str(cur_num_of_motif), '/Strategy_', num2str(cur_strategy), '/amp_scale_', num2str(amp_scale(k)), '/', algorithm_type, 'Recall_'];
            FScore_file_path = ['/Users/sliu104/Desktop/Results_Motif_Save/Motif', num2str(cur_num_of_motif), '/Strategy_', num2str(cur_strategy), '/amp_scale_', num2str(amp_scale(k)), '/', algorithm_type, 'FScore_'];
            ...
            aggregated_precision = zeros(size(testCaseIndex, 2), num_of_motif+1+1);
            aggregated_recall = zeros(size(testCaseIndex, 2), num_of_motif+1+1);
            aggregated_FScore = zeros(size(testCaseIndex, 2), num_of_motif+1+1);
            for ii = 1 : size(testCaseIndex, 2)
                precision_file = [precision_file_path, num2str(testCaseIndex(ii)), '.csv'];
                recall_file = [recall_file_path, num2str(testCaseIndex(ii)), '.csv'];
                FScore_file = [FScore_file_path, num2str(testCaseIndex(ii)), '.csv'];
