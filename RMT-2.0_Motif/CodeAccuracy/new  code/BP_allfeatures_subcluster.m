...
% clc; clear;
function BP_allfeatures_subcluster(path,kindofinj,TEST,FeaturesRM,kindofCluster,measure,ClusterAlg,subfolderClusterLabel,DepO,DepT)
%% Analize Results
...
if(exist(strcat(path,'Features_',FeaturesRM,'\',TEST,'\Accuracy\subcluster\'),'dir')==0)
    ...
    xlswrite([path,'Features_',FeaturesRM,'\',TEST,'\Accuracy\','BP_',TEST,'_AllFeatureFound_DepO_',DepO,'_DepT_',DepT,'.csv'],FeatureClassCount,'BP_all_SubC','A2');
    xlswrite([path,'Features_',FeaturesRM,'\',TEST,'\Accuracy\','BP_',TEST,'_AllFeatureFound_DepO_',DepO,'_DepT_',DepT,'.csv'],col_header,'BP_all_SubC','A1');
...
%     xlswrite([path,'Features_',FeaturesRM,'\',TEST,'\Accuracy\','BP_',TEST,'_AllFeatureFound_DepO_',DepO,'_DepT_',DepT,'.csv'],FeatureClassCount,'BP_all_SubC','A2');
%     xlswrite([path,'Features_',FeaturesRM,'\',TEST,'\Accuracy\','BP_',TEST,'_AllFeatureFound_DepO_',DepO,'_DepT_',DepT,'.csv'],col_header,'BP_all_SubC','A1');
% %     csvwrite([path,'Features_',FeaturesRM,'\',TEST,'\Accuracy\','BP_all_SubC_',TEST,'_AllFeatureFound_DepO_',DepO,'_DepT_',DepT,'.csv'],FeatureClassCount);
% % xlswrite([path,'Features_',FeaturesRM,'\',TEST,'\Accuracy\subcluster\','BP_',TEST,'_AllFeatureFound_DepO_',DepO,'_DepT_',DepT,'.csv'],FeatureClassCount);
