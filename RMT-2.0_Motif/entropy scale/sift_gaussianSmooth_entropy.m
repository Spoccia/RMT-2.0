function [tempFrames,descriptors,gss,dogss,depd,idm, time, timee, timeDescr]=sift_gaussianSmooth_entropy(I, LocM, Ot, Od, St, Sd, sigmaTime ,sigmaDepd, NBP, gthresh, r,sBoundary, eBoundary)
% [M,N,C] = size(I) ;
