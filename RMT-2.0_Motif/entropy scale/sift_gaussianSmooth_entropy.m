function [tempFrames,descriptor_silv,gss,dogss,depd,idm, time, timee, timeDescr, featureDepdScale, featureTimeScale]=sift_gaussianSmooth_entropy(I, LocM, Ot, Od, St, Sd, sigmaTime ,sigmaDepd, NBP, gthresh, r,sBoundary, eBoundary)
% [M,N,C] = size(I) ;
