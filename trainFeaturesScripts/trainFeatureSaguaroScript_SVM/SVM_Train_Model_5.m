    ...
    for clusterID = 1:size(ClassIndexes,2)-1
        ...
        for OT =1: 3
            for OD = 1:3
                ...
                SVMModel = fitcsvm(OctaveFeatures(startDescr:endDescr,:)',OctaveClassification, 'KernelFunction','linear','Standardize',true,'ClassNames',{'1','2'});
