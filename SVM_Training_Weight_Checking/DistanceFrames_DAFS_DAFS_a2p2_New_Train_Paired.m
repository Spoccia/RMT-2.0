function [Dist, remainQOctave, time] = DistanceFrames_DAFS_DAFS_a2p2_New_Train_Paired(gss1, feature1, idm1, gss2, feature2, idm2, descr1, descr2, XuniqueFeature,Ximportance, Xproject, XdescrRange,amp1,amp2, queryTimeSeriesLength)
...
for i = 1:size(Feature1, 1)
    ...
    featureCount = featureLookUp_SVM_Paired(XuniqueFeature, relevantFeatureVector, isPaired);
    featureWeight = 0;
...
featureImp(:) = 1;
depdScale1 = depdScale1(:, nonzero_entries);
