function runMoCapSigmaT28SigmaD05_DAFS_DAFS_a2p2_Paired_Union_SVM_Weight()
...
trainPath = ['/Users/sicongliu/Desktop/features/NewPara/FullScale_SigmaT28SigmaD05_Octave3/SVM_Union_Feature_Importance_Paired'];
unionFeaturePath = ['/Users/sicongliu/Desktop/features/NewPara/FullScale_SigmaT28SigmaD05_Octave3'];

saveFolder = ['./save_SigmaT28SigmaD05_DAFS_DAFS_a2p2_Paired_Union_SVM_Weight_Folder_', num2str(scriptIndex), '/'];
...
for i = inputRange(1): inputRange(2)
    ...
    for j = 1: size(fileList, 2)
        ...
        XuniqueFeature = load ([trainPath, '/uniqueFeature_', num2str(i), '.csv']);
        Ximportance = load([trainPath, '/importance_', num2str(i), '.csv']);
        Xproject = load([trainPath, '/projectMatrix_', num2str(i), '.csv']);
        XdescrRange = load([trainPath, '/descrRange_', num2str(i), '.csv']);
