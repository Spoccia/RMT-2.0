...
BaseName='Motif1numInst_10';%'MV_Sync_Motif';%'Motif1';%
dataLocation='data\';
...
%     Name_OriginalSeries = [23,35,86,111];% MOCap Motif10%
    ...
    for percentid=1:size(percent,1)
        ...
        DepO =2;
        DepT =2;
        for strID =2:2:size(strategy,2)%1:size(strategy,2)%1:size(strategy,2)%9%5:6%4:6%4:6%1:size(strategy,2)
