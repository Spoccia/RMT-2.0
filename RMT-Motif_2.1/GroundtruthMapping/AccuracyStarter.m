...
path='D:\Motif_Results\Datasets\SynteticDataset\Energy\';%BSONG\';
dataLocation='data\';
...
%     Name_OriginalSeries = [23,35,86,111];% MOCap Motif10%
    Name_OriginalSeries = [1,3,6,7];%ENERGY [64,70,80,147];Bsong%[85,35,127,24];Mocap % name of the original  series from with we  got the  motif instances to inject
    ...
    for percentid=1:1%size(percent,1)
        ...
        for strID =3:3%1:size(strategy,2)
            ...
            for pip=1:4%size(Name_OriginalSeries,2)
