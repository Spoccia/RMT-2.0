...
for DSIdx =3:3
   ...
   % path=['D:\Motif_Results\Datasets\SynteticDataset\',Ds_Name,'\',Ds_Name,' Motifs 1 2 3 same variate multisize\'];%RandomVariate\instancessamesize\'];%Coherent Shift Variate 1M ',Ds_Name,'\instancessamesize\'];%BirdSong\samesize10inst\';%Coherent Shift Variate 1M Energy\instancessamesize\';%
    ...
    BaseName=['Motif1numInst_',num2str(possnuminst(indpossnuminst))];%'Motif';%'MV_Sync_Motif1';%'MV_Sync_Motif1';%
    NO_V_subcluster=0;
    dataLocation='data\';
