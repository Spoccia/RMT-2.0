...
%         numInstancesinjected=5;
        ...
        %',Ds_Name,'\Coherent Shift Variate 1M ',Ds_Name,'\instancessamesize\'];%
...
%                                           GroundTruthFile = [GroundTruthFilePath, '_', num2str(TS_index(j)), '_instance_', num2str(testCaseIndex(i)), '_', num2str(amp_scale(m)), '.csv'];
                                            ...
                                            if(strcmp(cur_algorithm_type,'MStamp') == 1)
                                                ...
                                                MotifFile = [MotifFilePath, '/',BaseName,  '_', num2str(TS_index(j)),'_',num2str(numInstancesinjected), '_instance_', num2str(testCaseIndex(k)), '_', num2str(amp_scale(m)), '.csv'];
%                                                 MotifFile = [MotifFilePath, '/',BaseName,  '_', num2str(TS_index(j)), '_instance_', num2str(testCaseIndex(k)), '_', num2str(amp_scale(m)), '.csv'];
                                                ...
                                                MotifFile = [MotifFilePath, '/Strategy_', num2str(cur_strategy), '/AP_DepO_2_DepT_2_',BaseName, '_', num2str(TS_index(j)),'_',num2str(numInstancesinjected), '_instance_', num2str(testCaseIndex(k)), '_', num2str(amp_scale(m)), '.csv'];
