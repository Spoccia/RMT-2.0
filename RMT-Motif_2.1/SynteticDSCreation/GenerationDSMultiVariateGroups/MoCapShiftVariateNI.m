...
coherentinjectionFlag = 1  %% coherent % 0 not coherent
        ...
        for rwscale = 1 : size(random_walk_scale,2)
            for i =1 : random_walk_instance
                ...
                for motifInstance = 1: motif_instances*num_of_motif
                    ...
                    StartRWvalues=Motif1RW(:,starterTime(motifInstance)-1);
                    RwtoShift= Motif1RW(:,starterTime(motifInstance):TotalRWlength);%Motif1RW(:,starterTime(motifInstance)-1:TotalRWlength);
                    ...
                    Motif1RW(actualVariateToinject((actualVariateToinject(:,1)>0),1),starterTime(motifInstance)+scalingTime:TotalRWlength)= ...
                        RwtoShift(actualVariateToinject((actualVariateToinject(:,1)>0),1),1:end-scalingTime);%2:end-scalingTime);
