...
featuresToInjectPath=[basepath,DataType,'\',DataType,'RandomShift\SameSize\data\FeaturesToInject\'];%'CoherentShift\MultiSize\data\FeaturesToInject\'];
%,'\RandomVariate\instancessamesize\data','\FeaturesToInject\',];
randomWalkPath = [basepath,DataType,'\',DataType,'RandomShift\SameSize\data\RW_0_1/RW_'];%'CoherentShift\MultiSize\data\RW_0_1/RW_'];
...
num_of_motif=1;
delimiter='/';
DestDataPath = [basepath,DataType,'\',DataType,'RandomShift\SameSize\data\'];%'CoherentShift\MultiSize\data\'];
...
for orgID = 1:30 %length(originalTSIDArray)%2
 ...
 %   length_percentage_1 = [1,0.75,0.5,1,0.75,0.5,1,0.75,0.5,1,0.75,0.5];%[1,0.75,0.5];
    ...
    for pssMotID = 1 : num_of_motif% 3%length(possibleMotifNUM)%4:4
        ...
        PossibleMotifs2rooms=[3 4 1 2 5 6 8 9 10 11 ;
        ...
        for MotifId =1: num_of_motif
            ...
            if coherentinjectionFlag == 1  %% coherent
                ...
                for instanceMOTIFVariate =1: motif_instances
                    SetOfVaraite(:,instanceMOTIFVariate) = randperm(13,size(PossibleMotifs2rooms,1));
                end
            end
