...
featuresToInjectPath=[basepath,DataType,'\',DataType,'RandomShift\MultiSize\data\FeaturesToInject\'];%'CoherentShift\MultiSize\data\FeaturesToInject\'];
%,'\RandomVariate\instancessamesize\data','\FeaturesToInject\',];
randomWalkPath = [basepath,DataType,'\',DataType,'RandomShift\MultiSize\data\RW_0_1/RW_'];%'CoherentShift\MultiSize\data\RW_0_1/RW_'];
...
num_of_motif=1;
delimiter='/';
DestDataPath = [basepath,DataType,'\',DataType,'RandomShift\MultiSize\data\'];%'CoherentShift\MultiSize\data\'];
%'\RandomVariate\instancessamesize\data'];
NUM_VARIATE = 27;%Energy
%NUM_VARIATE = 62;% MoCap
% NUM_VARIATE = 13;% BirdSong
coherentinjectionFlag = 0;% not coherent1  %% coherent % 
