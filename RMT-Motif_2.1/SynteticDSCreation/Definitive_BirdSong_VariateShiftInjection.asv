...
featuresToInjectPath=[basepath,DataType,'\',DataType,'CoherentShift\MultiSize\data\FeaturesToInject\'];
...
randomWalkPath = [basepath,DataType,'\',DataType,'CoherentShift\MultiSize\data\RW_0_1/RW_'];
...
num_of_motif=1;
delimiter='/';
% DestDataPath = [basepath,DataType,'\',DataType,'RandomShift\MultiSize\data\'];%
DestDataPath = [basepath,DataType,'\',DataType,'CoherentShift\MultiSize\data\'];
