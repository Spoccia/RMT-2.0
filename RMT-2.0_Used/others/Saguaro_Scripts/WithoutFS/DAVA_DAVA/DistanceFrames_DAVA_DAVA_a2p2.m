function [Dist, remainQOctave] = DistanceFrames_DAVA_DAAAVA_a1p2(gss1, feature1, idm1, gss2, feature2, idm2, descr1, descr2, maxTime1, minTime1, maxTime2, minTime2, amp1,amp2)
remainQOctave = [];
...
[matches, VcombineScore, CheckValues]=mySiftMatch_DAVA_DAVA_SameOct( descr1, descr2, feature1, feature2, depdScale1, depdScale2, amp1, amp2);
