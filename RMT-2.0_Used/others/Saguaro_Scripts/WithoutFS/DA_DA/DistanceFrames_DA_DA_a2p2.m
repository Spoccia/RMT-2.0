function [Dist, remainQOctave] = DistanceFrames_DA_DA_a2p2(gss1, feature1, idm1, gss2, feature2, idm2, descr1, descr2, maxTime1, minTime1, maxTime2, minTime2, amp1,amp2)
remainQOctave = [];
% read features
