function [Dist, remainQOctave] = DistanceFrames_DATP_DAAATP_a1p2(gss1, feature1, idm1, gss2, feature2, idm2, descr1, descr2, maxTime1, minTime1, maxTime2, minTime2, amp1,amp2)
remainQOctave = [];
...
[matches, VcombineScore, CheckValues]=mySiftMatch_DATP_DATP_SameOct( descr1, descr2, feature1, feature2, maxTime1, minTime1, maxTime2, minTime2, minScope,amp1, amp2,DtempMinScope1,DtempMinScope2,DtempMaxScope1, DtempMaxScope2, TtempMinScope1,TtempMinScope2,TtempMaxScope1, TtempMaxScope2, MVariateSize);
