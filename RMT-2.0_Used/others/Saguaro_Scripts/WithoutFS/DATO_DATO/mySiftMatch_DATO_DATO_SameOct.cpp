        ...
        int nin, const mxArray *in[])
{
     ...
     ** --------------------------------------------------------------- */
    {
        ...
        for(k1 = 0 ; k1 < K1 ; ++k1, L1_pt += ND, Feature1_pt += NDFeature1,amp1_pt += 1)
        {
            ...
            double maxTime = max(maxTime1, maxTime2);
            double minTime = min(minTime1, minTime2);
...
//                     timeScore2 = 0;
//                 else
//                     timeScore2=abs( tempAbs )/( maxTime - minTime);
//                 
//                 timeScore2 = 1 - timeScore2;
//                 double timeScoreOverlap = (timeScore1 + timeScore2)/2;
//                 double tempScopet = (tscope1 + tscope2)/2;
...
//                 double timeScore = timeScoreOverlap;
                ...
                double matchingScore = acc * timeScoreOverlap;
                double pruneScore = acc * timeScoreOverlap;
