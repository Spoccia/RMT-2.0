function runMoCapSigmaT28SigmaD05_DAFS_DAFS_a2p2_Paired_1()
...
dataPath = ['./data/mocap/'];
fileList = 1: 184;
trainPath = ['./FullScale_SigmaT28SigmaD05_Octave3/SVM_UnPaired'];
unionFeaturePath = ['./FullScale_SigmaT28SigmaD05_Octave3'];
saveFolder = ['./save_SigmaT28SigmaD05_DAFS_DAFS_a2p2_Paired_Folder_', num2str(scriptIndex), '/'];
...
for i = inputRange(1): inputRange(2)
    ...
    for j = 1: size(fileList, 2)
        ...
        [Dist(i,j), remainOctave] = DistanceFrames_DAFS_DAFS_a2p2_Paired_New_Train(gss11, frame11, idm11, gss22, frame22, idm22, descr11, descr22,XuniqueFeature,Ximportance, Xproject, XdescrRange,Xamp1,Xamp2, queryTimeSeriesLength);
