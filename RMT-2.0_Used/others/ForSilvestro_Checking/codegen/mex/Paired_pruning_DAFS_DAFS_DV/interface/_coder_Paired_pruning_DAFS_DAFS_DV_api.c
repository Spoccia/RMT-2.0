 ...
 *
 * Code generation for function '_coder_Paired_pruning_DAFS_DAFS_DV_api'
 *
 */
...
#include "_coder_Paired_pruning_DAFS_DAFS_DV_api.h"
#include "Paired_pruning_DAFS_DAFS_DV_emxutil.h"
#include "Paired_pruning_DAFS_DAFS_DV_data.h"

/* Variable Definitions */
static emlrtRTEInfo l_emlrtRTEI = { 1, 1,
  "_coder_Paired_pruning_DAFS_DAFS_DV_api", "" };
...
void Paired_pruning_DAFS_DAFS_DV_api(const mxArray * const prhs[8], const
  mxArray *plhs[2])
{
  ...
  emxInit_real_T(&st, &feature1, 2, &l_emlrtRTEI, true);
  emxInit_real_T(&st, &depdScale1, 2, &l_emlrtRTEI, true);
  emxInit_real_T(&st, &matches, 2, &l_emlrtRTEI, true);
  emxInit_real_T(&st, &combineScore, 2, &l_emlrtRTEI, true);
  emxInit_real_T(&st, &feature2, 2, &l_emlrtRTEI, true);
  emxInit_real_T(&st, &depdScale2, 2, &l_emlrtRTEI, true);
  emxInit_real_T(&st, &remainQOctave, 2, &l_emlrtRTEI, true);
  ...
  Paired_pruning_DAFS_DAFS_DV(&st, feature1, depdScale1, matches, combineScore,
...
/* End of code generation (_coder_Paired_pruning_DAFS_DAFS_DV_api.c) */
