 ...
 *
 * Code generation for function '_coder_Paired_pruning_DAFS_DAFS_DV_info'
 *
 */
...
#include "_coder_Paired_pruning_DAFS_DAFS_DV_info.h"
...
static void b_info_helper(const mxArray **info)
{
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[E]D:/RMT 2_0/RMT-2.0/ForSilvestro_Checking/Paired_pruning_DAFS_DAFS_DV.m!overlap"),
                "context", 77);
...
static void c_info_helper(const mxArray **info)
{
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[E]D:/RMT 2_0/RMT-2.0/ForSilvestro_Checking/Paired_pruning_DAFS_DAFS_DV.m"),
                "context", 142);
...
/* End of code generation (_coder_Paired_pruning_DAFS_DAFS_DV_info.c) */
