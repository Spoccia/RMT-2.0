function [Dist, remainQOctave] = DistanceFrames_DA_DA_a2p2_Paired_SVM(gss1, feature1, idm1, gss2, feature2, idm2, descr1, descr2, amp1,amp2, featureImp)
remainQOctave = [];
% featureImp(featureImp < 0 ) = 0.01;
featureImp = ones(size(featureImp, 1), 1);
[depdScale1] = computeDepdScale_unionOnly(feature1, gss1, idm1);
[depdScale2] = computeDepdScale_unionOnly(feature2, gss2, idm2);

[matches, VcombineScore, CheckValues]=mySiftMatch_DAFS_DAFS_SameOct( descr1, descr2, feature1, feature2,amp1, amp2, featureImp);
